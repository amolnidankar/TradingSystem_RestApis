...
import com.trading_system.service.TradingCompanyServiceImpl;
...
public class Services_Testing {
	...
	@InjectMocks
	TradingCompanyServiceImpl tradingCompanyServiceimpl ;
	private ModelMapper modelMapper = new ModelMapper();

	@BeforeEach
	void setUp() {
		Customer customer1 = new Customer(1, "Swami", "Tata", 100, 500, 50, "1234567891", "1234567891",
...
//	Reading The Customer By Id
	...
	public void test_find_by_id() {
		long id = 4L;
		Customer c1 = new Customer(id, "Swami", "Tata", 100, 500, 50, "1234567891", "1234567891",
				"Amrut-Ganga Building,Near MG Road,Flat no 16,8th Floor,Pune-411041", "1234567891", "1234567891",
				"Average Share", "1234567891");	
		 Customer cus= customerDao.findById(id).get();
		assertEquals(4L,cus.getId());
	}
