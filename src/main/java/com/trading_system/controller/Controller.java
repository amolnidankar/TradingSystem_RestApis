...
//	Reading the All Customers.
	...
	public ResponseEntity<List<CustomerDto>> getCustomers() {
		...
		List<CustomerDto> c = this.tradingCompanyService.getCustomers();
		return new ResponseEntity<>(c, HttpStatus.OK);
...
//	Updating the Customer  Details.
	...
	public ResponseEntity<CustomerDto> updateCustomer(@RequestBody CustomerDto id) {

		CustomerDto c = this.tradingCompanyService.updateCustomer(id);
		return new ResponseEntity<>(c, HttpStatus.CREATED);
	}
